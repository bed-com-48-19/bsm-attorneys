    ...
    <div className="w-screen h-20 z-10 bg-gradient-to-r from-indigo-600 to-blue-500 fixed shadow-lg">
      <div className="px-6 flex justify-between items-center w-full h-full">
        ...
        <div className="hidden md:flex">
          <Link to="/signin">
            <button className="bg-white text-indigo-600 px-6 py-2 rounded-full shadow-md hover:bg-gray-100 transition duration-300">
              Sign In
            </button>
          </Link>
        </div>
      ...
      <ul
        ...
        } bg-gradient-to-r from-indigo-600 to-blue-500 w-full px-8`}
      >
        ...
        <div className="flex flex-col my-4">
          <Link to="/signin" onClick={toggleNav}>
            <button className="bg-white text-indigo-600 px-8 py-3 mb-4 rounded-full shadow-md hover:bg-gray-100 transition duration-300">
              Sign In
            </button>
          </Link>
        </div>
